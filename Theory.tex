...
k_a\int\displaylimits_{\Omega_A}D\Delta T \mathrm{d}\Omega + k_b \int\displaylimits_{\Omega_b}D\frac{\partial T}{\partial n}\mathrm{d}\Gamma \\- k_b\int\displaylimits_{\Omega_B}D\Delta T \mathrm{d}\Omega + \alpha \int\displaylimits_{\Gamma_1}D\left(T-T_{\infty}\right)\mathrm{d}\Gamma = 0\\
\left.D\right|_{\Gamma} = 0 \rightarrow k_a\int\displaylimits_{\Gamma_{A_{outer}}}D\frac{\partial T}{\partial n}\mathrm{d}\Gamma = 0,\\
...
k_a\int\displaylimits_{\partial_{A_{inner}}}D\frac{\partial T}{\partial n} \mathrm{d}\Gamma + k_b\int\displaylimits_{\partial_{B}}D\frac{\partial T}{\partial n} \mathrm{d}\Gamma = 0\\
k_a\int\displaylimits_{\partial_{A}}D\frac{\partial T}{\partial n} \mathrm{d}\Gamma - k_b\int\displaylimits_{\partial_{B}}D\frac{\partial T}{\partial n} \mathrm{d}\Gamma = 0\\
\end{gather*}
